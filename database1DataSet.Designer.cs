...
namespace LINQ2SQL {
    ...
    public partial class database1DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Name, string Adress) {
...
namespace LINQ2SQL.database1DataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Code] = @Original_Code) AND ((@IsNull_Name " +
                "= 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Adress = 1 A" +
                "ND [Adress] IS NULL) OR ([Adress] = @Original_Adress)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Name], [Adress]) VALUES (@Name, @Adress);\r\nSELECT " +
                "Code, Name, Adress FROM Employee WHERE (Code = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Name] = @Name, [Adress] = @Adress WHERE (([Code] = @Original_Code) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Adress = 1 AND [Adress] IS NULL) OR ([Adress] = @Original_Adress)));
SELECT Code, Name, Adress FROM Employee WHERE (Code = @Code)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LINQ2SQL.Properties.Settings.Default.database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Code, Name, Adress FROM dbo.Employee";
        ...
        public virtual int Delete(int Original_Code, string Original_Name, string Original_Adress) {
        ...
        public virtual int Update(string Name, string Adress, int Original_Code, string Original_Name, string Original_Adress, int Code) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Adress, int Original_Code, string Original_Name, string Original_Adress) {
            return this.Update(Name, Adress, Original_Code, Original_Name, Original_Adress, Original_Code);
        }
    }
